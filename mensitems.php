...
<section>
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="col-md-9">
                    <h1 style="color:green">Means Items:</h1>
                    <p>We are glad to introduce you, Zeysha Group has been launched which however has grown at a tremendous pace to become one of the top Stock Lot Company in Bangladesh. And with the latest product which able to produce even more complex Stock Lot ranging Business.</p>
                ...
                <div class="col-md-3">
                    <h3>Our Services:</h3>
                    <ul>
                        <li><a href="garment.php">Knitting</a></li>
                        <li><a href="garment.php">Woven</a></li>
                        <li><a href="garment.php">Sweater</a></li>
                        <li><a href="leather.php">Leather</a></li>
                        <li><a href="jute.php">Jute</a></li>
                        <li><a href="index.php">Home Products</a></li>
                        <li><a href="stocklot.php">Stock Lot</a></li>
                    </ul>
                </div>
            </div>
        </div>
